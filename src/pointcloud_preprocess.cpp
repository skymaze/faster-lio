...
void PointCloudPreprocess::Process(const livox_ros_driver2::msg::CustomMsg::UniquePtr &msg, PointCloudType::Ptr &pcl_out) {
    AviaHandler(msg);
    *pcl_out = cloud_out_;
}

void PointCloudPreprocess::Process(const sensor_msgs::msg::PointCloud2::UniquePtr &msg, PointCloudType::Ptr &pcl_out) {
    switch (lidar_type_) {
        ...
        default:
            RCLCPP_ERROR(rclcpp::get_logger("pointcloud_preprocess"), "Error LiDAR Type");
            break;
    }
    *pcl_out = cloud_out_;
}

void PointCloudPreprocess::AviaHandler(const livox_ros_driver2::msg::CustomMsg::UniquePtr &msg) {
    cloud_out_.clear();
    cloud_full_.clear();
...
void PointCloudPreprocess::Oust64Handler(const sensor_msgs::msg::PointCloud2::UniquePtr &msg) {
    cloud_out_.clear();
    cloud_full_.clear();
...
void PointCloudPreprocess::VelodyneHandler(const sensor_msgs::msg::PointCloud2::UniquePtr &msg) {
    cloud_out_.clear();
    cloud_full_.clear();
